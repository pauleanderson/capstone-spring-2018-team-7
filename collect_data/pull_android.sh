...
do
    ...
    do
        node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 0 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_0.json 
        i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_0.json)
        until [ $i -eq 0 ]
        do
            node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 0 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_0.json 
            i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_0.json)
        ...
        node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 100 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_100.json
        i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_100.json)
        until [ $i -eq 0 ]
        do
            node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 100 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_100.json 
            i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_100.json)
        ...
        node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 200 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_200.json
        i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_200.json)
        until [ $i -eq 0 ]
        do
            node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 200 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_200.json 
            i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_200.json)
        ...
        node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 300 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_300.json
        i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_300.json)
        until [ $i -eq 0 ]
        do
            node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 300 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_300.json 
            i=$(grep -c 'Error: Error' ~/capstone-spring-2018-team-7/collect_data/android/${chart}_300.json)
        ...
        node ~/capstone-spring-2018-team-7/collect_data/gplay_${chart}.js -c $country -i 400 | tr -d '[]' > ~/capstone-spring-2018-team-7/collect_data/android/${chart}_400.json
