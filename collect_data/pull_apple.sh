...
do
    ...
    do
        node ~/capstone-spring-2018-team-7/collect_data/apl_${chart}.js -c $country | jsonlint-py -f -q -S > ~/capstone-spring-2018-team-7/collect_data/apple/${country}_${chart}_${date}.json
    done
done
